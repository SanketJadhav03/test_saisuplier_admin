...
export const IMG_API_URL = "http://localhost:8001";
...
export const sendMail = async (templateName, item, emailTo) => {
  axios
    .post(`${API_URL}/send-template-email`, {
...
export const sendWhatsApp = async (phone, array,templateName) => {
  axios
    .post(`${API_URL}/send/whatsapp`, {
      templateName:templateName,
      phone: phone,
      array:array,
    })
