...
const ProductUpdate = (props) => {
  ...
  const addProduct = (index) => {
    ...
    SetMultiProduct([
      ...ProductMulti,
      { ...FindArray[0], product_price_id: null },
    ]);
  };
  ...
  const [oldMultipleImages, setOldMultipleImages] = useState(
    PrmaryImfomation.product_multiple_image != "[]"
      ? PrmaryImfomation.product_multiple_image?.split(",")
      : []
  );
  ...
  const removeNewImage = (index) => {
    const updated = [...multipleImg];
    updated.splice(index, 1);
    setMultipleImg(updated);
  };
  ...
  const SubmitData = () => {
    ...
    formData.append("product_id", PrmaryImfomation.product_id);
    if (singleImg) {
    ...
    formData.append(
      "kept_multiple_images",
      oldMultipleImages.length > 0 ? oldMultipleImages.join(",") : null
    );
        ...
        http
          ...
          .then(function (response) {
            ...
            props.checkchang({
              ...
              PrimaryImformation: response.data.PrimaryImformation,
              update: 1,
            });
          })
          .catch(function (error) {
                    ...
                    <Col lg={3}>
                      <div className="mb-3">
                        ...
                        <Input
                          ...
                          name="product_weight"
                          value={PrmaryImfomation.product_weight}
                          onChange={(e) => PramryImformtion(e)}
                        />
                      </div>
                    </Col>
                    <Col lg={3}>
                      <div className="mb-3">
                        ...
                        <Select
                          ...
                          placeholder={
                            manageCategory == 0
                              ? PrmaryImfomation.category_name
                    ...
                    <Col lg={3}>
                      <div className="mb-3">
                        ...
                        <Select
                          ...
                          placeholder={
                            MainInfromation.bank?.find(
                              (b) =>
                                b.bank_category ==
                                  PrmaryImfomation.product_category &&
                                b.bank_id == PrmaryImfomation.product_bank
                            )?.bank_name
                          }
                          options={
                    ...
                    <Col lg={3}>
                      <div className="mb-3">
                        ...
                        <Select
                          ...
                          defaultValue={{
                            label: PrmaryImfomation.tax_name,
                            value: PrmaryImfomation.product_tax_pressent,
                          }}
                          options={
                            MainInfromation.tax &&
                          ...
                          defaultValue={{
                            label:
                              PrmaryImfomation.product_tax_type == 1
                                ? "Inclusive Tax"
                                : "Exclusive Tax",
                            value: PrmaryImfomation.product_tax_type,
                          }}
                          options={[
                    ...
                    <Col lg={3}>
                      <div className="mb-3">
                        ...
                        <Select
                          ...
                          defaultValue={{
                            value: PrmaryImfomation.product_unit_price,
                            label: PrmaryImfomation.unit_name,
                          }}
                          options={
                              ...
                              <div className="avatar-title bg-light rounded">
                                {singleImg ? (
                                  <img
                                    ...
                                    width={"100px"}
                                  />
                                ) : PrmaryImfomation.product_image ? (
                                  <img
                                    src={`${IMG_API_URL}/products/${PrmaryImfomation.product_image}`}
                                    alt="old-product-img"
                                    className="h-auto"
                                    width={"100px"}
                                  />
                    ...
                    <Col lg={9}>
                      <div className="mb-4">
                        ...
                        <div className="d-flex gap-2 flex-wrap align-items-start">
                          {/* Old Images */}
                          {oldMultipleImages?.map((img, index) => (
                            <div
                              key={`old-${index}`}
                          ...
                          {multipleImg?.map((img, index) => (
                            ...
                            >
                              ...
                              <button
                                ...
                                className="btn btn-sm btn-dark position-absolute top-0 end-0 m-1 p-1"
                                style={{
                                  lineHeight: "1",
                                  fontSize: "0.8rem",
                                  borderRadius: "50%",
