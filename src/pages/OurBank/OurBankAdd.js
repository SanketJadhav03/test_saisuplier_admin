...
const OurBankAdd = (props) => {
  const [modal, setModal] = useState(false);
  const [OurBankName, SetOurBankName] = useState("");
  ...
  const SubmitData = () => {
    if (OurBankName == "") {
      ...
      https
        .post("/ourBank/store", { ourBank_img: OurBankImg, ourBank_name: OurBankName })
                      ...
                      <div className="avatar-lg">
                        <div className="avatar-title bg-light rounded">
                          {OurBankImg ? (
                            <img
                              src={
                                OurBankImg ? URL.createObjectURL(OurBankImg) : ""
                              }
                              id="product-img"
                              alt="product-img"
                              className="h-auto"
