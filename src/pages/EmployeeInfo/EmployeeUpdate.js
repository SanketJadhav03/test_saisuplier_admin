...
const EmployeeUpdate = (props) => {
  ...
  const onSubmited = () => {
    if (employeeData.basic_firstname == "") {
      ...
      http
        .put("/employee/update", employeeData)
        .then((response) => {
                ...
                <TabPane tabId="1">
                  <Row>
                    ...
                    <div className="col-4 mt-3">
                      ...
                      <div>
                        <input type="radio" checked={employeeData.basic_gender && employeeData.basic_gender==1?true:false} className="btn-check shadow" value={1} name="basic_gender" onClick={(e) => {
                          setEmployeeData({
                            ...employeeData,
                        ...
                        <input type="radio" checked={employeeData.basic_gender && employeeData.basic_gender==0?true:false} className="btn-check shadow" value={0} name="basic_gender" onClick={(e) => {
                          setEmployeeData({
                            ...employeeData,
                            basic_gender: e.target.value
                          });
                        ...
                        <input type="radio" checked={employeeData.basic_gender && employeeData.basic_gender==2?true:false} className="btn-check shadow" value={2} name="basic_gender" onClick={(e) => {
                          setEmployeeData({
                            ...employeeData,
                            basic_gender: e.target.value
                          });
