...
const Suppliers = () => {
  ...
  const onClickEdit = (index) => {
    let FindArray = getSupplierData.filter((_, i) => i == index);
  ...
  useEffect(() => {
    document.title = "Suppliers | Saisupplier Admin";
  ...
  useEffect(() => {
    http
      .get(`/suppliers/list?page=${Pages}&limit=30`)
      .then(function (response) {
        setSupplierData([...getSupplierData, ...response.data]);
        SetPages(Pages + 1);
            ...
            <Card>
              <CardHeader className="card-header border-0">
                <Row className="align-items-center gy-3">
                  <div className="col-sm">
                    <h5 className="card-title mb-0">Suppliers </h5>
                  </div>
              ...
              <CardBody className="pt-0">
                <div>
                  ...
                  ></Nav>
                  <InfiniteScroll
                    dataLength={getSupplierData.length}
                    next={fetchData}
                    hasMore={NoMore}
                  >
                    <table
                    ...
                    >
                      ...
                      <tbody>
                        {getSupplierData.map((item, index) => (
                          <tr key={index}>
                            <td>{index + 1}</td>
                            ...
                            <td>{item.supplier_opening_balance}</td>
                                  ...
                                  &&  
                                    ...
                                    {permission.find(permission => permission.permission_category === "SUPPLIER" && permission.permission_path === "4") 
                                      ...
                                      {item.supplier_id != 1 ? (
                                        <button
                                          onClick={() =>
                                            onClickDelete(item.supplier_id)
                                          }
