...
import { sendMail } from "../../helpers/url_helper";
  ...
  const handleStatusUpdate = async (order, selectedOption) => {
    ...
    try {
      await https.post("/order/update-status", {
        ...
        master_status: Number.parseInt(selectedOption?.value),
...
export default Sale_List_packing;
