...
import SampleProductAdd from "./SampleProductAdd";
import SampleProductUpdate from "./SampleProductUpdate";
                ...
                <Row className="align-items-center gy-3">
                  ...
                  <div className="col-sm-auto">
                    <div className="d-flex gap-1 flex-wrap">
                      ...
                      {permission.find(
                        (permission) =>
                          permission.permission_category === "SAMPLEPRODUCTS" &&
                      ...
                      <tbody>
                        {ProductData.map((item, index) => (
                          <tr key={index}>
                            ...
                            <td>{item.product_marathi_name}</td>
                            <td>{item.tax_name}</td>
...
export default SampleProductsList;
