...
const FranchiseView = (props) => {
  ...
  const [SalesManData, setSalesManData] = useState(props.edit_data);
            ...
            <Card className="border card-border-success  p-3 shadow-lg">
              <div className="mb-3 row">
                <div className="col-4">
                  ...
                  <Input
                    readOnly
                    value={SalesManData.supplier_name}
                    name="supplier_name"
                    id="supplier_name"
                ...
                <div className="col-4">
                  ...
                  <Input
                  value={SalesManData.supplier_mobile}
                    readOnly
                ...
                <div className="col-4">
                  ...
                  <Input
                  value={SalesManData.supplier_email}
                    readOnly
                    name="supplier_email"
                    id="supplier_email"
                    className="form-control fw-bold"
                ...
                <div className="col-3">
                  ...
                  <Input
                  value={SalesManData.supplier_gst_no}
                    readOnly
                ...
                <div className="col-3">
                  ...
                  <Input
                  value={SalesManData.supplier_pan_no}
                    readOnly
                ...
                <div className="col-3">
                  ...
                  <Input
                  value={SalesManData.supplier_opening_balance}
                    readOnly
                ...
                <div className="col-3">
                  ...
                  readOnly
                  className="form-control fw-bold"
                  value={SalesManData.supplier_group_name}
                  />
                </div>
                ...
                <div className="col-6">
                  ...
                  <textarea
                  value={SalesManData.supplier_billing_address}
                    readOnly
                    rows={3}
                ...
                <div className="col-6">
                  ...
                  <textarea
                  value={SalesManData.supplier_shipping_address}
                    readOnly
                    rows={3}
                ...
                <div className="col-4">
                  ...
                  <Input
                  value={SalesManData.supplier_city}
                    readOnly
                    name="supplier_city"
                    id="supplier_city"
                    className="form-control fw-bold"
                ...
                <div className="col-4">
                  ...
                  <Input
                  value={SalesManData.supplier_credit_limit}
                    readOnly
                ...
                <div className="col-4">
                  ...
                  <Input
                  value={SalesManData.supplier_credit_period_day}
                    readOnly
