...
import OtherChrageAdd from "./OtherChrageAdd"; // updated name
import OtherChrageUpdate from "./OtherChrageUpdate"; // updated name
import AuthUser from "../../helpers/Authuser";
import InfiniteScroll from "react-infinite-scroll-component";

const OtherChrageList = () => {
  ...
  useEffect(() => {
    document.title = "Other Charges | Saisupplier Admin";
  ...
  const handleDeleteOrder = (data) => {
    if (data._reactName === "onClick") {
      http
        .delete(`/other_charges/delete/${ID}`)
              ...
              <CardHeader className="card-header border-0">
                <Row className="align-items-center gy-3">
                  <div className="col-sm">
                    <h5 className="card-title mb-0">Other Charges</h5>
                  </div>
                          ...
                          <td>
                            <ul className="list-inline hstack gap-2 mb-0">
                              ...
                              <li className="list-inline-item">
                                {item.other_charges_id !== 1 ? (
                                  <button
                                    onClick={() =>
                                      onClickDelete(item.other_charges_id)
                                    }
...
export default OtherChrageList;
