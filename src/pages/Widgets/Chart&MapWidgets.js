            ...
            <CardHeader className="align-items-center d-flex">
              ...
              <div className="flex-shrink-0">
                <Button
                  color="primary"
                  size="sm"
                  className="btn-soft-primary shadow-none"
                >
                  Export Report
                </Button>
              </div>
          ...
          <Card className="card-height-100">
            ...
            <CardBody>
              <div id="sales-by-locations" style={{ height: "269px" }}>
                <Vector value="us_aea" color="#f3f6f9" />
              </div>
              <div className="px-2 py-2 mt-1">
                <p className="mb-1">
                  New Maxico <span className="float-end">75%</span>
                </p>
                <Progress
                  color="primary"
                  value={75}
                ...
                <p className="mt-3 mb-1">
                  California <span className="float-end">47%</span>
                </p>
                <Progress
                  color="primary"
                  value={47}
                ...
                <p className="mt-3 mb-1">
                  Texas <span className="float-end">82%</span>
                </p>
                <Progress
                  color="primary"
                  value={82}
                    ...
                    <div className="d-flex">
                      ...
                      <div className="flex-grow-1 ms-2">
                        ...
                        <p className="fs-12 mb-0 text-muted">
                          <i
                            className={
                              "mdi mdi-circle fs-10 align-middle me-1 text-" +
                              item.coinNameClass
                            }
                          ></i>
                          {item.coinName}
