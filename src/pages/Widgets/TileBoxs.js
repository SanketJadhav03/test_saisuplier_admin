                        ...
                        <div className="flex-grow-1 ms-3">
                          <h2 className="mb-0">
                            <span className="counter-value">
                              <span>
                                {item.prefix || ""}
                                {Number(item.counter || 0).toLocaleString(
                                  "en-IN",
                                  {
                                    minimumFractionDigits: item.decimals ?? 0,
                                    maximumFractionDigits: item.decimals ?? 0,
                ...
                <div className="d-flex justify-content-between">
                  ...
                  <div>
                    <div className="avatar-sm flex-shrink-0">
                      <span
                        className={
                          "avatar-title rounded-circle fs-2 bg-" +
                          item.iconClass
                        }
                      >
                        <FeatherIcon
              ...
              <CardBody>
                <div className="d-flex align-items-center">
                  <div className="avatar-sm flex-shrink-0 shadow">
                    <span
                      className={
                        "avatar-title rounded-2 fs-2 bg-" +
                        item.iconClass +
                        " text-" +
                        item.color
                      }
            ...
            <Card className={"card-height-100 " + item.class}>
              <CardBody>
                ...
                <p className="text-muted mb-0">
                  <i className="ri-building-line align-bottom"></i> Themesbrand{" "}
                  <span className="ms-2">
                    <i className="ri-map-pin-2-line align-bottom"></i>{" "}
                    California
                  </span>
                </p>
              </CardBody>
