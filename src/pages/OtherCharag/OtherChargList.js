...
import OtherChargAdd from "./OtherChargAdd";
import OtherChargUpdate from "./OtherChargUpdate";

const OtherChargList = () => {
  ...
  useEffect(() => {
    document.title = "Other Charge | Saisupplier Admin";
  ...
  useEffect(() => {
    http
      .get(`/expenses/list?page=${Pages}&limit=30`)
      .then(function (response) {
              ...
              <CardHeader className="card-header border-0">
                <Row className="align-items-center gy-3">
                  <div className="col-sm">
                    <h5 className="card-title mb-0">Other Charge </h5>
                  </div>
                              ...
                              <ul className="list-inline hstack gap-2 mb-0">
                                ...
                                <li className="list-inline-item">
                                  {item.expenses_id != 1 ? (
                                    <button
                                      onClick={() =>
                                        onClickDelete(item.expenses_id)
                                      }
